---
description: This tutorial will explain how to delegate/stake/unstake your BDCC.
---

# Staking tutorial

Note: You can only stake BDCC which is on Bitica network. Please make sure you have changed into Bitica network in Metamask while doing any transactions on staking UI. 

How to Stake Bitica:

**Step 1:**

Navigate to staking.biticablockchain.com and login to your wallet through metamask. Make sure you are on Bitica network. If you are not please follow the instructions [**here**](https://docs.biticablockchain.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask).
...
You will also see the APY on staking when you enter the amount of BDCC you want to stake. You can see the staked amount right next to the validator name to whom you have delegated you stake to. 
