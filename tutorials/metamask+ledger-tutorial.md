...
We will learn how to connect Ledger to Metamask and use it on Bitica network after the latest Metamask and Ledger live update.
...
You will be logged in to the address you selected and now you can change to “Bitica network” and perform the transactions on Bitica network through your Ledger device.

Note: To learn how to add Bitica network RPC follow [this link.](https://docs.biticablockchain.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask)
