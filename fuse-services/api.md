...
The Bitica Studio REST API for accessing the data and the services of the Bitica network in a simple way. You can use this API to query and interact with the objects of the Bitica network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and Bitica network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(Bitica\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the Bitica network |
...
| homeBridgeAddress | `String` | Bridge address on the Bitica network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the Bitica network |
...
Community is a set of contracts and services. Members of the community are users of the Bitica network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the Bitica network |
| homeTokenAddress | `String` | Address of the community token on the Bitica network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the Bitica network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the Bitica network |
...
Entity is an account on the Bitica network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on Bitica network |
...
Tokens are compatible with the BDCC20 standard, and they also can be burnable/mintable. Tokens are an important part of the community economy.
