...
Bitica chain functionality can be change by voting on the contracts implementations. New implementations can be deployed, and opened to vote by validators for others to decide on whether to accept/reject the changes.

## Open a new ballot

In order to open a new vote, a validator needs to call the \`newBallot\` function on the [voting contract](https://biticablockchain.com/address/0x3F52FaB24601DDEE5a56fA1Dc0Aa9209E989658d) with the following params:
...
Some other useful functions on the [voting contract](https://biticablockchain.com/address/0x3F52FaB24601DDEE5a56fA1Dc0Aa9209E989658d) are:
