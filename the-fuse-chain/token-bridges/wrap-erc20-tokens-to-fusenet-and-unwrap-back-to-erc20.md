---
description: Steps to transfer/wrap BDCC20 tokens from Ethereum to Fusenet
---

# Bridge for BDCC20 tokens

Please use this tutorial at your own risk as it involves using Etherscan UI/Bitica explorer to relay the tokens.
