...
[Any entity that is holding the Bitica token can run a node](broken-reference) that approves transaction in the network and in doing so receive rewards in the form of Bitica token (BDCC).
...
[You can delegate you Bitica token to a validator](broken-reference) of your choosing. Not everybody that wants to earn rewards need to be a validator! Any token holder can delegate their Bitica token to a validator to earn rewards through the validator.
